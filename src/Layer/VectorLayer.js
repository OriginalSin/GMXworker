var CurrClass = L.TileLayer.Canvas || L.GridLayer;
L.gmx.VectorLayer = CurrClass.extend({
    options: {
        openPopups: [],
        minZoom: 1,
        zIndexOffset: 0,
	...
	_update: function (center) {
        ...
        CurrClass.prototype._update.call(this, center);
    },
...
/*
    ...
    onAdd: function(map) {
        ...
        CurrClass.prototype.onAdd.call(this, map);
    ...
    _initContainer: function () {
        CurrClass.prototype._initContainer.call(this);
        this._prpZoomData();
    ...
    _updateShiftY: function() {
        ...
        L.DomUtil.setPosition(this._container, gmx.shiftPoint);
    },
